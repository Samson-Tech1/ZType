...
class MtLoWord implements ILoWord {
  ...
  ... this.draw(WorldScene w) ...      -- WorldScene
  ... this.anyOff() ...             --boolean
   ... this.move() ...             --ILoWord
    ... this.keyMatchesList(String key) ...             --boolean
     ... this.anyActive() ...             -- boolean
     ... this.turnActive(String key) ...             -- boolean
   * w -- IWord
   * low -- ILoWord
   * s -- String
   * Methods on parameters
   * low.interleave(this.rest) -- ILoWord
   */
...
class ConsLoWord implements ILoWord {
  ...
  ... this.rest.addToEnd(IWord w) ...    -- ILoWord
  ... this.rest.filterOutEmpties() ...      -- ILoWord
  ... this.rest.draw(WorldScene w) ...      -- WorldScene
  ... this.rest.anyOff() ...             --boolean
   ... this.rest.move() ...             --ILoWord
    ... this.rest.keyMatchesList(String key) ...             --boolean
     ... this.rest.anyActive() ...             -- boolean
     ... this.rest.turnActive(String key) ...             -- boolean
   * w -- IWord
   * low -- ILoWord
   * s -- String
   * Methods on parameters
...
class ActiveWord extends AWord {
  ...
  ... this.y ...               -- int
METHODS:
  ... this.filterHelper() ...              -- boolean 
  ... this.checkHelper(String str) ...             -- IWord 
  ... this.extractCompare(IWord w) ...        -- int
  ... this.compare(String str) ...          -- int
  ... this.draw(WorldScene w) ...           -- WorldScene
  ... this.move() ...                       -- IWord
  ... this.isOff() ...                      -- boolean
  ... this.keyMatchesWord(String key)       -- boolean
...
... this.words.anyOff() ...               -- boolean
... this.words.draw(WorldScene w) ...      -- WorldScene
... this.words.keyMatchesList(String key) ...      -- boolean
... this.words.turnActive(String Key) ...      -- ILoWord
...
class Utils {
  /* TEMPLATE
   * METHODS:
   * ... this.letterNumber(int i) ...    -- int
   * * ... this.randomString(int i) ...    -- String
